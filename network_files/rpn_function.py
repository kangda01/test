...
class RegionProposalNetwork(torch.nn.Module):
    ...
    def assign_targets_to_anchors(self, anchors, targets):
        ...
        # for anchors_per_image, targets_per_image in zip(anchors, [targets[i] for i in range(targets.shape[0])]):
    ...
    def filter_proposals(self, proposals, objectness, image_shapes, num_anchors_per_level):
        ...
        for boxes, scores, lvl in zip(proposals, objectness, levels):
            ...
            boxes = box_ops.clip_boxes_to_image(boxes, image_shapes[-2:])
    ...
    def forward(self,
        ...
        # 筛除小boxes框，nms处理，根据预测概率获取前post_nms_top_n个目标
        boxes, scores = self.filter_proposals(proposals, objectness, images.shape, num_anchors_per_level)
